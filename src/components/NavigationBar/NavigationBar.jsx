  ...
  return (
    <div className= 'NaviBar'>
      ...
      <ul className="mainMenu">
        <li/><Link className="naviName" to='/'>Home</Link>

        <li/><Link className='naviName'to='/glasses'>Shop</Link>
        <li/><Link className="naviName" to = '/featured'>Featured</Link>
        <li/><Link className='naviName' to = '/cartnew'>CartNew</Link>
      ...
      <ul className="navigation-menu">
        <li className="navigation-menu-item">
          <button className="button-menu-link2">
            <div className="badge" onClick={ToggleCart}>
        ...
        <li className="navigation-action"></li>
